    ...
    <div className="relative text-center isolate bg-black w-full py-20 px-6 flex flex-col items-center gap-16">
      <div className="max-w-[880px] flex flex-col items-center gap-6">
        ...
        <div className="text-3xl md:text-5xl uppercase">
          TOP AI-CURATED YIELD OPPORTUNITIES
        </div>
        <div className="text-lg md:text-[22px] opacity-80 max-w-[668px]">
          Preview the top-performing strategies curated by our AI engine. Update
          in real time
        </div>
      </div>
      ...
      <div className="w-full max-w-7xl overflow-x-auto">
        <div className="min-w-[800px]">
          <div className="flex justify-around border-b border-white/10 pb-4 mb-4 text-left px-4">
            <div className="w-40 text-center text-xl md:text-[22px]">
              Strategy
            </div>
            <div className="w-40 text-center text-xl md:text-[22px]">APY</div>
            <div className="w-40 text-center text-xl md:text-[22px]">
              Risk Score
            </div>
            <div className="w-40 text-center text-xl md:text-[22px]">Chain</div>
          ...
          {[1, 2, 3].map((_, index) => (
            <div
              key={index}
              className="flex justify-around items-center py-6 px-4 border-b border-white/5 hover:bg-white/5 transition-colors text-left group"
            >
              <div className="flex items-center gap-4">
                ...
                <div>
                  <div className="text-xs text-[#F2DE45] uppercase mb-1">
                    Automated hedging
                  </div>
              ...
              <div className="w-40 text-center">
                <span
                  className={`px-3 py-1 rounded-[4px] text-sm border ${
                    index === 0
                      ? "text-[#F24548] border-[#F24548]/30 bg-[#F24548]/10"
                      : index === 1
                        ? "text-[#F2DE45] border-[#F2DE45]/30 bg-[#F2DE45]/10"
      ...
      <div className="flex flex-col sm:flex-row items-center gap-6 justify-center mt-8">
        <button className="h-[43px] rounded-[4px] px-8 py-2 hover:bg-[#3bb0d9] transition-all myBtn flex items-center justify-center cursor-pointer bg-black text-black font-semibold">
          Start Earning
        </button>

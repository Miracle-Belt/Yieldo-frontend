...
const Banner = () => {
        return(
            <div className="relative isolate px-6 lg:px-8 w-full min-h-[800px] flex flex-col items-center justify-center overflow-hidden">
                <div className = "relative z-10 max-w-[953px] text-center mt-20 flex flex-col gap-6">
                    <div className = "text-4xl md:text-5xl lg:text-[64px] font-bold leading-tight uppercase">
                ...
                <div className = "relative z-10 max-w-[634px] text-center flex flex-col gap-6 mt-20 md:mt-32">
                    ...
                    <div className="mt-4">
                        <a href="#" className="underline opacity-60 hover:opacity-100 transition-opacity">Integrate</a>
                    </div>
                </div>
                <video
                    src={videoSrc}
